...
- ### **[SimpleClans](https://www.spigotmc.org/resources/71242/)**
  ...
  You can find an up-to-date list of placeholders in the [SimpleClans Wiki](https://simpleclans.gitbook.io/simpleclans/other/placeholderapi-support).
...
- ### **[Towny](https://github.com/TownyAdvanced/Towny)**
  ...
  You can find an up-to-date list of placeholders in the [Towny wiki](https://github.com/TownyAdvanced/Towny/wiki/Placeholders).
